...
export default async function NewConsultationPage(props: { searchParams: Promise<{ templateId?: string }> }) {
    ...
    return (
        <div className="flex flex-col flex-1 max-w-4xl mx-auto w-full pt-2">
            <div className="flex-1 flex flex-col justify-start animate-in fade-in slide-in-from-bottom-4 duration-700 gpu-accelerated">
